...
function echoContent($filename)
{
   ...
   $QUERY = mysql_query("SELECT * FROM `content` WHERE CONVERT( `address` USING utf8 ) = '$filename'");
...
// Updates the given row in the content table with the given address and html
function updatePage($address, $html)
{
   global $server, $username, $password, $db;
